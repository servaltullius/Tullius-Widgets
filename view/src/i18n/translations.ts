...
export const bundledTranslations = {
  ko: {
    ...
    language: '언어',
    fontPreset: '글꼴 프리셋',
    fontPresetDefault: '기본',
    fontPresetReadable: '가독성',
    fontPresetCompact: '압축형',
    fontPresetClassic: '고전형',
    iconTheme: '아이콘 스타일',
    iconThemeStandard: '기본 아이콘',
    iconThemeDororong: '도로롱 아이콘',
    showIconBadges: '아이콘 위 보조 뱃지',
    korean: '한국어',
    english: 'English',
    resistances: '저항력',
    magic: '마법',
    ...
    progressionWidgetPanel: '성장 진행도',
    integratedProgressionWidget: '통합 진행 위젯',
    ...
    playerInfo: '플레이어 정보',
    level: '레벨',
    standaloneLevel: '별도 레벨 표시',
    experience: '현재 경험치',
    expToNextLevel: '레벨업까지 경험치',
    gold: '골드',
    carryWeight: '소지 무게',
    carryWeightDisplay: '소지 무게 표시',
    resistanceDisplay: '저항력 표시',
    timeDisplay: '시간 표시',
    timedEffectsLayout: '배치 방향',
    numberAndMeter: '숫자+바',
    numberOnly: '숫자만',
    meterOnly: '바만',
    effectiveOnly: '실효값만',
    ...
    dragHint: '* 설정 창이 열린 동안 위젯을 직접 드래그하거나 리사이즈할 수 있습니다.',
    editVisibilityHint: '* 편집 중에는 숨겨진 위젯도 임시로 표시됩니다.',
    close: '닫기',
    tabGeneral: '일반',
    tabCombat: '전투 수치',
    tabEffects: '효과/시간',
  ...
  en: {
    ...
    fontPresetDefault: 'Default',
    fontPresetReadable: 'Readable',
    fontPresetCompact: 'Compact',
    fontPresetClassic: 'Classic',
    iconTheme: 'Icon Style',
    iconThemeStandard: 'Standard Icons',
    iconThemeDororong: 'Dororong Icons',
    showIconBadges: 'Show Icon Badges',
    korean: '한국어',
    english: 'English',
    ...
    progressionWidgetPanel: 'Progression',
    integratedProgressionWidget: 'Integrated Progression Widget',
    ...
    level: 'Level',
    standaloneLevel: 'Standalone Level Display',
    experience: 'Current XP',
    expToNextLevel: 'XP To Next Level',
    gold: 'Gold',
    carryWeight: 'Carry Weight',
    carryWeightDisplay: 'Carry Weight Display',
    resistanceDisplay: 'Resistance Display',
    timeDisplay: 'Time Display',
    timedEffectsLayout: 'Layout Direction',
    numberAndMeter: 'Number + Meter',
    numberOnly: 'Number Only',
    meterOnly: 'Meter Only',
    ...
    dragHint: '* Drag or resize widgets directly while settings are open.',
    editVisibilityHint: '* Hidden widgets are temporarily shown while editing.',
    close: 'Close',
    tabGeneral: 'General',
